...
extractorName = os.getenv('RABBITMQ_QUEUE', "terra_PSIIExtractor")
...
getPSIIExtractorScript = "PSII_analysis.py"
...
outputDir = '/Users/nijiang/Desktop/pythonTest/PSII_clowderTest'
